...
            className="bg-gray-800/50 rounded-lg p-6 h-96 animate-pulse"
          >
          </motion.div>
        </div>
      </div>
...
          className="bg-gray-800/50 backdrop-blur-md rounded-lg p-6 border border-gray-700 mb-6 transition-all duration-300 hover:shadow-lg hover:border-blue-900 relative"
        >
          {/* Action buttons row */}
...
          {/* Animated elements for a more engaging entry */}
          <motion.h1
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="text-3xl font-bold mb-3 text-white hover:text-orange-300 transition-colors duration-300 pr-32"
          >
            {title}
          </motion.h1>

          {/* Enhanced metadata badges with staggered animation */}
          <motion.div
...
          >
            <motion.span variants={itemVariants} className={`px-3 py-1 rounded-full text-sm font-medium text-white bg-${getGenreColor(genre)}`}>
              {genre}
            </motion.span>
...
          >
            <motion.span variants={itemVariants} className="flex items-center space-x-1 hover:text-indigo-300 text-indigo-100 transition-colors duration-200">
              <Calendar size={16} />
              <span>{formatDate(createdAt)}</span>
            </motion.span>
            <motion.span variants={itemVariants} className="flex items-center space-x-1 hover:text-teal-300 text-teal-100 transition-colors duration-200">
              <Eye size={16} />
...
              className="text-gray-300 whitespace-pre-line text-base leading-relaxed p-4"
            >
