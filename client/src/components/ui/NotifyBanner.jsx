...
const NotifyBanner = ({ message, type = 'info', duration = 3000, onClose }) => {
    ...
    return (
        <div className="fixed bottom-5 right-5 z-50">
            <div className={`flex items-center ${config.bgColor} border-l-4 ${config.borderColor} ${config.textColor} px-4 py-3 rounded-lg shadow-lg w-[300px] animate-bounce-in`}>
