...
export const EditPost = ({
  ...
  if (!isAuthor) {
    return (
      <div className="w-full bg-gray-900 flex items-center justify-center px-4">
    ...
    <div className="w-full bg-gray-900 text-white">
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">Edit your blog post and make it shine!</p>
        </div>
        ...
        <SimpleBar
          ...
          className="pb-4"
        >
          <form onSubmit={postEditedBlog} className="space-y-8 pr-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className={`w-full p-4 bg-gray-800 border rounded-lg focus:outline-none transition-all duration-200 text-white text-lg ${isTitleValid
              ...
              <div className="space-y-6">
                ...
                <div className="flex-1">
                  ...
                  <textarea
                    rows={12}
                    className={`w-full p-4 bg-gray-800 border rounded-lg focus:outline-none transition-all duration-200 text-white resize-none ${isContentValid
                      ? 'border-gray-600 focus:border-blue-500'
                      : 'border-red-500 focus:border-red-400'
                      }`}
                    value={content}
            ...
            <div className="border-t border-gray-700 pt-6">
                ...
                {getRequiredFields().length > 0 ? (
                  <div className="bg-yellow-900/30 border border-yellow-600 rounded-lg p-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-yellow-400 font-medium mb-2">Required to Enable Update:</h4>
                  ...
                  <div className="bg-green-900/30 border border-green-600 rounded-lg p-4">
                    <div className="flex items-center">
                      ...
                      <span className="text-green-400 font-medium">Ready to update! All requirements met.</span>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <Button
                  type="submit"
                  className={`px-8 py-4 rounded-lg transition-all duration-200 font-medium text-lg flex items-center ${isFormValid
