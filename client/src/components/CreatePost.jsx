    ...
    <div className="w-full bg-gray-900 text-white">
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-gray-400 mt-1 sm:mt-2 text-sm sm:text-base">Share your thoughts with the world!</p>
        </div>
                ...
                {getRequiredFields().length > 0 ? (
                  <div className="bg-yellow-900/30 border border-yellow-600 rounded-lg p-3 sm:p-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-yellow-400 font-medium mb-2 text-sm sm:text-base">Required to Create Post:</h4>
                  ...
                  <div className="bg-green-900/30 border border-green-600 rounded-lg p-3 sm:p-4">
                    <div className="flex items-center">
                      ...
                      <span className="text-green-400 font-medium text-sm sm:text-base">Ready to post! All requirements met.</span>
                    </div>
                  </div>
                )}
              </div>
